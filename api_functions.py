...
patoolib.extract_archive(rar_path, outdir=extracted_path)
# Ahora puedes trabajar con el archivo extraído
ruta_archivo_extraido1 = extracted_path + 'df_items.parquet'
df_items = pd.read_parquet(ruta_archivo_extraido1)


rar_path2 = 'datasets/data/parquet/user_sim_df.rar'
extracted_path2 = 'datasets/data/parquet/'
# Extraer el archivo RAR
patoolib.extract_archive(rar_path2, outdir=extracted_path2)
# Ahora puedes trabajar con el archivo extraído
ruta_archivo_extraido2 = extracted_path2 + 'user_sim_df.parquet'
