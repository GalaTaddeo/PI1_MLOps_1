...
# Datos a utilizar
df_reviews = pd.read_parquet('dataset/data/parquet/df_reviews.parquet')
df_items = pd.read_parquet('dataset/data/parquet/df_items.parquet')
df_juegos = pd.read_parquet('dataset/data/parquet/df_games.parquet')
piv_norm = pd.read_parquet('dataset/data/parquet/piv_norm.parquet')
item_sim_df = pd.read_parquet('dataset/data/parquet/item_sim_df.parquet')
user_sim_df = pd.read_parquet('dataset/data/parquet/user_sim_df.parquet')
