...
with rarfile.RarFile(rar_path, 'r') as rar:
    # Obtener el nombre del primer archivo en el RAR
    file_inside_rar = rar.namelist()[0]
    # Extraer el archivo a una ruta específica
    rar.extract(file_inside_rar, path='datasets/data/parquet')
# Ahora puedes trabajar con el archivo extraído
ruta_archivo_extraido1 = 'datasets/data/parquet/' + file_inside_rar


# Ruta al archivo RAR
rar_path = 'datasets/data/parquet/user_sim_df.rar'
# Crear un objeto RarFile
with rarfile.RarFile(rar_path, 'r') as rar:
    # Obtener el nombre del primer archivo en el RAR
    file_inside_rar = rar.namelist()[0]
    ...
    rar.extract(file_inside_rar, path='datasets/data/parquet')
# Ahora puedes trabajar con el archivo extraído
ruta_archivo_extraido2 = 'datasets/data/parquet/' + file_inside_rar
